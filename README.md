...
# 📖 BookKraze <a name="about-project"></a>

BookKraze is a website that allows you to:
...
Feel free to check the [issues page](https://github.com/lucy-sees/React-BookKraze/issues).
...
I would like to thank all code reviewers for their suggestions to make this project better.
